...
class TestMeasureTimeToMerge(unittest.TestCase):
    ...
    def test_measure_time_to_merge_ready_for_review(self):
        ...
        pull_request.merged_at = datetime.fromisoformat("2021-01-04T00:00:00Z")
    ...
    def test_measure_time_to_merge_created_at(self):
        ...
        # Create a mock pull request object
        pull_request = MagicMock()
        pull_request.merged_at = datetime.fromisoformat("2021-01-04T09:00:00Z")
        pull_request.created_at = datetime.fromisoformat("2021-01-01T09:00:00Z")
